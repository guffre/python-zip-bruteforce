def brutezip(zip_path, alphabet="abcdefghijklmnopqrstuvwxyz", length=8, min=1):
    """Usage: brutezip(<file_path>, <bruteforce characters>, <max length>, <min length>)
    Example: brutezip("C:\\myfile.zip", "0123456789ABCDEFabcdef", 12)
    This checks C:\myfile.zip for all hex combinations up to length 12
    Requires the following imports: struct, zipfile, itertools"""
